...
Definition bin_string_of_nat (n : nat) : string
  := bin_string_of_N (N.of_nat n).
...
Definition nat_of_bin_string (s : string) : nat
  := N.to_nat (N_of_bin_string s).
...
Lemma nat_of_bin_string_of_nat (n : nat)
  : nat_of_bin_string (bin_string_of_nat n)
    = n.
Proof.
  cbv [nat_of_bin_string bin_string_of_nat];
    rewrite N_of_bin_string_of_N, Nnat.Nat2N.id; reflexivity.
Qed.
...
Example bin_string_of_N_0 : bin_string_of_N 0 = "0b0" := eq_refl.
Example bin_string_of_Z_0 : bin_string_of_Z 0 = "0b0" := eq_refl.
Example bin_string_of_Z_m1 : bin_string_of_Z (-1) = "-0b1" := eq_refl.
Example bin_string_of_nat_0 : bin_string_of_nat 0 = "0b0" := eq_refl.
